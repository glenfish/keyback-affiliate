...
We only make payment in cryptocurrency. There are four options: Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), XRP and Stellar Lumens (XLM). Please make sure you add at least ONE payout address. You can select which payment address as your primary one. This will be the one we will make payment to.
...
A summary of sign ups and statement of referral fees is available to the Affiliate by logging into their Affiliate Admin System.
